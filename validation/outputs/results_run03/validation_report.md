...
- **Precision:** 0.310 (54 TP, 120 FP)
- **Recall:** 1.000 (54 TP, 0 FN)
- **F1-Score:** 0.474
...
|--------|-------|------------|
| True Positives | 54 | 31.0% |
| False Positives | 120 | 69.0% |
...
- 70.4% of detections within ±5m of manual boundary
- 100.0% of detections within ±10m of manual boundary
- Mean absolute error: 3.88m
