...
- **Precision:** 0.771 (27 TP, 8 FP)
- **Recall:** 0.750 (27 TP, 9 FN)
- **F1-Score:** 0.761
...
|--------|-------|------------|
| True Positives | 27 | 61.4% |
| False Positives | 8 | 18.2% |
| False Negatives | 9 | 20.5% |
...
- 77.8% of detections within ±5m of manual boundary
- 100.0% of detections within ±10m of manual boundary
- Mean absolute error: 3.46m
